...
class Trainer(CIFARTrainer):
    ...
    def train_privately(self, target_model, attack_model, target_optimizer, num_batches=10000, num_loaders_to_defend=3):
        ...
        for loader_idx, subset_loader in enumerate(loaded_dataloader_list):
