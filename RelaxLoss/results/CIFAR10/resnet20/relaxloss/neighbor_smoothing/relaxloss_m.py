...
class CustomLoss(nn.Module):
    ...
    def forward(self, pairwise_distances, mean_neighbors):
...
class Trainer(CIFARTrainer):
    ...
    def train(self, model, optimizer, epoch):
        ...
        for batch_idx, (inputs, targets) in enumerate(self.trainloader):
            ...
            neighbor_loss = self.custom_loss(self.pairwise_distances,self.mean_neighbors)
            ...
            self.pairwise_distances[start_idx:end_idx, start_idx:end_idx] = batch_distances
