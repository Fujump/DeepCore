...
sys.path.append(os.path.join(FILE_DIR, 'models'))
sys.path.append(os.path.join(FILE_DIR, 'dataset'))
...
def parse_arguments():
    ...
    # parser.add_argument('--attack_member_loader', '-member', type=torch.utils.data.DataLoader,help='member_loader')
    # parser.add_argument('--attack_nonmember_loader', '-nonmember', type=torch.utils.data.DataLoader, help='nonmember_loader')
    # parser.add_argument("--subset_data",type=torch.Tensor)
    # parser.add_argument("--subset_labels",type=torch.Tensor)
    # parser.add_argument("--sampled_indices",type=torch.Tensor)
    return parser
