...
class NNAttackTrainer(BaseTrainer):
    ...
    def construct_dataloader(stat_pos, stat_neg):
        ...
        attack_loader = data.DataLoader(attack_dataset, batch_size=256, shuffle=True,generator=torch.Generator(device = 'cuda'))
